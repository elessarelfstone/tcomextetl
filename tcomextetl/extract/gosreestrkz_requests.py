...
class GosreestrKzRequests(HttpRequest):
    ...
    def test_url(self):
        try:
            response = requests.get(self.url, headers=self.header(), timeout=10, verify=False)
    ...
    def test_proxies(self):
        ...
        for _ in range(10):
            ...
            try:
                ...
                print(f"Proxies Status Code: {response.status_code}")
            except Exception as e:
    ...
    def get_request_url(self):
        ...
        print(f"Post Request Code: {response.status_code}")
    ...
    def get_all_bins_json(self):
        ...
        print(f'bin value = {self.bins_list}')
