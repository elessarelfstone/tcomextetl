...
StructRegister.add('dgov_datasets_mugedektigi_bar_adamdarga_arna', DgovDatasetsMugedektigiBarAdamdargaArnaRow)
StructRegister.add('dgov_datasets_ata_anasynyn_kamkorlygynsyz_ka', DgovDatasetsAtaAnasynynKamkorlygynsyzKaRow)
StructRegister.add('dgov_datasets_memlekettik_auruhanalar_tizbes1', DgovDatasetsMemlekettikAuruhanalarTizbes1Row)
StructRegister.add('dgov_datasets_perechen_gosudarstvennyh_rodi', DgovDatasetsPerechenGosudarstvennyhRodiRow)
StructRegister.add('dgov_datasets_perechen_gosudarstvennyh_disp', DgovDatasetsPerechenGosudarstvennyhDispRow)
StructRegister.add('dgov_datasets_perechen_gosudarstvennyh_bol', DgovDatasetsPerechenGosudarstvennyhBolRow)
StructRegister.add('dgov_datasets_304_perechen_gosudarstvennyh', DgovDatasets304PerechenGosudarstvennyhRow)
StructRegister.add('dgov_datasets_307_perechen_gosudarstvennyh', DgovDatasets307PerechenGosudarstvennyhRow)
StructRegister.add('dgov_datasets_grd_vko', DgovDatasetsGrdVkoRow)
StructRegister.add('dgov_datasets_pgb_vko', DgovDatasetsPgbVkoRow)
StructRegister.add('dgov_datasets_psio_vko', DgovDatasetsPsioVkoRow)
# samruk
...
StructRegister.add('telecomkz_logs_redesign3_visits', TelecomkzRedesignLogsRow)
