...
TELECOMKZ_YANDEX_METRICA_LOGS_REDESIGN3_TOKEN = os.getenv('TELECOMKZ_YANDEX_METRICA_LOGS_REDESIGN3_TOKEN')
...
CLOUDPAYMENTS_USER = os.getenv('CLOUDPAYMENTS_USER')
CLOUDPAYMENTS_PASS = os.getenv('CLOUDPAYMENTS_PASS')
CLOUDPAYMENTS_NO3DS_USER = os.getenv('CLOUDPAYMENTS_NO3DS_USER')
CLOUDPAYMENTS_NO3DS_PASS = os.getenv('CLOUDPAYMENTS_NO3DS_PASS')
...
AMPLITUDE_EGOV_LOGS_API_KEY_2 = os.getenv('AMPLITUDE_EGOV_LOGS_API_KEY_2')
AMPLITUDE_EGOV_LOGS_SECRET_KEY_2 = os.getenv('AMPLITUDE_EGOV_LOGS_SECRET_KEY_2')
...
AMPLITUDE_LOYALTY_PROGRAM_LOGS_API_KEY = os.getenv('AMPLITUDE_LOYALTY_PROGRAM_LOGS_API_KEY')
AMPLITUDE_LOYALTY_PROGRAM_LOGS_SECRET_KEY = os.getenv('AMPLITUDE_LOYALTY_PROGRAM_LOGS_SECRET_KEY')

PROXY_FACTORY_USER = os.getenv('PROXY_FACTORY_USER')
PROXY_FACTORY_PASS = os.getenv('PROXY_FACTORY_PASS')

SHOP_TELECOMKZ_NURSAT_PLUS_TOKEN = os.getenv('SHOP_TELECOMKZ_NURSAT_PLUS_TOKEN')

ELECTRONIC_QUEUE_LOGIN = os.getenv('ELECTRONIC_QUEUE_LOGIN')
ELECTRONIC_QUEUE_PASSWORD = os.getenv('ELECTRONIC_QUEUE_PASSWORD')

ROCKETDATA_TOKEN = os.getenv('ROCKETDATA_TOKEN')

QUALYS_API_USER = os.getenv('QUALYS_API_USER')
QUALYS_API_PASSWORD = os.getenv('QUALYS_API_PASSWORD')
