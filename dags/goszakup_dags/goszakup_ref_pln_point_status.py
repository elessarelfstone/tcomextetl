...
with DAG(dag_id='goszakup_ref_pln_point_status',
         catchup=False,
    ...
    goszakup_ref_pln_point_status = ExternalEtlDockerRunner(
        task_id='ggoszakup_ref_pln_point_status',
        luigi_module='goszakup',
        luigi_task='GoszakupRefPlnPointStatus',
