...
with DAG(dag_id='goszakup_ref_fkrb_program',
         catchup=False,
    ...
    goszakup_ref_fkrb_program = ExternalEtlDockerRunner(
        task_id='goszakup_ref_fkrb_program',
        luigi_module='goszakup',
        luigi_task='GoszakupRefFkrbProgram',
