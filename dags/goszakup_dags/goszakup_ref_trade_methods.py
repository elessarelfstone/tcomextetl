...
with DAG(dag_id='goszakup_ref_trade_methods',
         catchup=False,
    ...
    goszakup_ref_trade_methods = ExternalEtlDockerRunner(
        task_id='goszakup_ref_trade_methods',
        luigi_module='goszakup',
        luigi_task='GoszakupRefTradeMethods',
