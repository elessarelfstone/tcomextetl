...
with DAG(dag_id='goszakup_ref_subject_type',
         catchup=False,
    ...
    goszakup_ref_subject_type = ExternalEtlDockerRunner(
        task_id='goszakup_ref_subject_type',
        luigi_module='goszakup',
        luigi_task='GoszakupRefSubjectPointStatus',
