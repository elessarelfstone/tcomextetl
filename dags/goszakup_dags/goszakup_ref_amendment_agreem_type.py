...
with DAG(dag_id='goszakup_ref_amendm_agreem_justif',
         catchup=False,
    ...
    goszakup_ref_amendm_agreem_justif = ExternalEtlDockerRunner(
        task_id='goszakup_ref_amendm_agreem_justif',
        luigi_module='goszakup',
        luigi_task='GoszakupRefAmendmAgreemJustif',
