...
with DAG(dag_id='goszakup_ref_justification',
         catchup=False,
    ...
    goszakup_ref_justification = ExternalEtlDockerRunner(
        task_id='goszakup_ref_justification',
        luigi_module='goszakup',
        luigi_task='GoszakupRefJustification',
