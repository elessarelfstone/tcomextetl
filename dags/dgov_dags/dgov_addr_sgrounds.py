...
with DAG(
        dag_id='dgov_address_register_sgrounds',
        catchup=False,
    ...
    dgov_address_register_sgrounds = Runner(
        task_id='dgov_address_register_sgrounds',
        luigi_module='dgov_addrreg',
        luigi_task='DgovAddrRegSGrounds',
    ...
    command_args >> dgov_address_register_sgrounds
