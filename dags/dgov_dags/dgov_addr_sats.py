...
with DAG(
        dag_id='dgov_address_register_sats',
        catchup=False,
    ...
    dgov_address_register_sats = Runner(
        task_id='dgov_address_register_sats',
        luigi_module='dgov_addrreg',
        luigi_task='DgovAddrRegSAts',
    ...
    command_args >> dgov_address_register_sats
