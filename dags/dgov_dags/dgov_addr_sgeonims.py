...
with DAG(
        dag_id='dgov_address_register_sgeonims',
        catchup=False,
    ...
    dgov_address_register_sgeonims = Runner(
        task_id='dgov_address_register_sgeonims',
        luigi_module='dgov_addrreg',
        luigi_task='DgovAddrRegSGeonims',
    ...
    command_args >> dgov_address_register_sgeonims
