...
with DAG(
        dag_id='dgov_address_register_dats_types',
        catchup=False,
    ...
    dgov_address_register_dats_types = Runner(
        task_id='dgov_address_register_dats_types',
        luigi_module='dgov_addrreg',
        luigi_task='DgovAddrRegDAtsTypes',
    ...
    command_args >> dgov_address_register_dats_types
