...
with DAG(
        dag_id='dgov_address_register_sbuildings',
        catchup=False,
    ...
    dgov_address_register_sbuildings = Runner(
        task_id='dgov_address_register_sbuildings',
        luigi_module='dgov_addrreg',
        luigi_task='DgovAddrRegSBuildings',
    ...
    command_args >> dgov_address_register_sbuildings
