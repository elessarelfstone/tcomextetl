...
with DAG(
    ...
    dgov_address_register_dgeonims_types = Runner(
        task_id='dgov_address_register_dgeonims_types',
        luigi_module='dgov_addrreg',
        luigi_task='DgovAddrRegDGeonimsTypes',
    ...
    command_args >> dgov_address_register_dgeonims_types
