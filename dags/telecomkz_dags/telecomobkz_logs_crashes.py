...
with DAG(
        dag_id='telecomobkz_logs_crashes',
        catchup=False,
    ...
    telecomobkz_logs_crashes = Runner(
        task_id='telecomobkz_logs_crashes',
        luigi_module='telecomkz',
        luigi_task='TelecomobkzYandexMetricaLogsCrushes',
    ...
    command_args >> telecomobkz_logs_crashes
