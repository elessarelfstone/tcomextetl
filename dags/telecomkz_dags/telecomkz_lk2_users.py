...
with DAG(
    ...
    telecomkz_lk2_users = Runner(
        task_id='telecomkz_lk2_visits',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaRepsLK2Users',
    ...
    command_args >> telecomkz_lk2_users
