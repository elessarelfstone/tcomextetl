...
with DAG(
        dag_id='telecomkz_logs_lk2_yam2_visits',
        catchup=False,
    ...
    telecomkz_logs_lk2_yam2_visits = Runner(
        task_id='telecomkz_logs_lk2_yam2_visits',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaLogsLK2Yam2Visits',
    ...
    command_args >> telecomkz_logs_lk2_yam2_visits
