...
with DAG(
        dag_id='telecomkz_logs_main_visits',
        catchup=False,
    ...
    telecomkz_logs_main_visits = Runner(
        task_id='telecomkz_logs_main_visits',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaLogsMainVisits',
    ...
    command_args >> telecomkz_logs_main_visits
