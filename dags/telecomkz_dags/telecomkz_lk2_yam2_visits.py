...
with DAG(
        dag_id='telecomkz_lk2_yam2_visits',
        catchup=False,
    ...
    telecomkz_lk2_yam2_visits= Runner(
        task_id='telecomkz_lk2_yam2_visits',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaRepsLK2Yam2Visits',
    ...
    command_args >> telecomkz_lk2_yam2_visits
