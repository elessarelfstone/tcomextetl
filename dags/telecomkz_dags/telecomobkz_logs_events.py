...
with DAG(
        dag_id='telecomobkz_logs_events',
        catchup=False,
    ...
    telecomobkz_logs_events = Runner(
        task_id='telecomobkz_logs_events',
        luigi_module='telecomkz',
        luigi_task='TelecomobkzYandexMetricaLogsEvents',
    ...
    command_args >> telecomobkz_logs_events
