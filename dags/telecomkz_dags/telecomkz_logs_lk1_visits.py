...
with DAG(
        dag_id='telecomkz_logs_lk1_visits',
        catchup=False,
    ...
    telecomkz_logs_lk1_visits = Runner(
        task_id='telecomkz_logs_lk1_visits',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaLogsLK1Visits',
    ...
    command_args >> telecomkz_logs_lk1_visits
