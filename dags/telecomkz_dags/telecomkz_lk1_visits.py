...
with DAG(
    ...
    telecomkz_lk1_visits = Runner(
        task_id='telecomkz_lk1_visits',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaRepsLK1Visits',
    ...
    command_args >> telecomkz_lk1_visits
