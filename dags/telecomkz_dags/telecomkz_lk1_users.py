...
with DAG(
    ...
    telecomkz_lk1_users = Runner(
        task_id='telecomkz_lk1_users',
        luigi_module='telecomkz',
        luigi_task='TelecomkzYandexMetricaRepsLK1Users',
    ...
    command_args >> telecomkz_lk1_users
