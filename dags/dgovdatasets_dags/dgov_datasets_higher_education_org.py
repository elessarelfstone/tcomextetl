...
with DAG(
        dag_id='dgov_datasets_higher_education_org',
        catchup=False,
    ...
    dgov_datasets_higher_education = Runner(
        task_id='dgov_datasets_higher_education_org',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsHigherEducationOrg',
    ...
    command_args >> dgov_datasets_higher_education
