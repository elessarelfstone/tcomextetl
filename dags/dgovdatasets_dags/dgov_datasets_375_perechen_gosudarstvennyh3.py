...
with DAG(
        dag_id='dgov_datasets_375_perechen_gosudarstvennyh3',
        catchup=False,
    ...
    dgov_datasets_375_perechen_gosudarstvennyh3 = Runner(
        task_id='dgov_datasets_375_perechen_gosudarstvennyh3',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasets375PerechenGosudarstvennyh3',
    ...
    command_args >> dgov_datasets_375_perechen_gosudarstvennyh3