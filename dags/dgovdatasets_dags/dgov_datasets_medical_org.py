...
with DAG(
        dag_id='dgov_datasets_medical_organizations',
        catchup=False,
    ...
    dgov_datasets_medical_org = Runner(
        task_id='dgov_datasets_medical_organizations',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsMedicalOrg',
    ...
    command_args >> dgov_datasets_medical_org
