...
with DAG(
        dag_id='dgov_datasets_perechen_gosudarstvennyh_bol',
        catchup=False,
    ...
    dgov_datasets_perechen_gosudarstvennyh_bol = Runner(
        task_id='dgov_datasets_perechen_gosudarstvennyh_bol',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPerechenGosudarstvennyhBol',
    ...
    command_args >> dgov_datasets_perechen_gosudarstvennyh_bol