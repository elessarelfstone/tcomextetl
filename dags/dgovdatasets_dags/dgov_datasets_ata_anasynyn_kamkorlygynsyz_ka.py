...
with DAG(
        dag_id='dgov_datasets_ata_anasynyn_kamkorlygynsyz_ka',
        catchup=False,
    ...
    dgov_datasets_ata_anasynyn_kamkorlygynsyz_ka = Runner(
        task_id='dgov_datasets_ata_anasynyn_kamkorlygynsyz_ka',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsAtaAnasynynKamkorlygynsyzKa',
    ...
    command_args >> dgov_datasets_ata_anasynyn_kamkorlygynsyz_ka