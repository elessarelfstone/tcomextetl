...
with DAG(
        dag_id='dgov_datasets_state_schools',
        catchup=False,
    ...
    dgov_datasets_state_schools = Runner(
        task_id='dgov_datasets_state_schools',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsStateSchools',
    ...
    command_args >> dgov_datasets_state_schools
