...
with DAG(
        dag_id='dgov_datasets_opendata_api_uri592',
        catchup=False,
    ...
    dgov_datasets_opendata_api_uri592 = Runner(
        task_id='dgov_datasets_opendata_api_uri592',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsOpendataApiUri',
    ...
    command_args >> dgov_datasets_opendata_api_uri592
