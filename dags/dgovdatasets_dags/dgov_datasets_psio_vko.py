...
with DAG(
    ...
    dgov_datasets_psio_vko = Runner(
        task_id='dgov_datasets_psio_vko',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPsioVko',
    ...
    command_args >> dgov_datasets_psio_vko