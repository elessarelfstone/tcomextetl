...
with DAG(
        dag_id='dgov_datasets_perechen_gosudarstvennyh_orga',
        catchup=False,
    ...
    dgov_datasets_perechen_gosudarstvennyh_orga = Runner(
        task_id='dgov_datasets_perechen_gosudarstvennyh_orga',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPerechenGosudarstvennyhOrga',
    ...
    command_args >> dgov_datasets_perechen_gosudarstvennyh_orga
