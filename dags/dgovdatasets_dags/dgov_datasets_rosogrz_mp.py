...
with DAG(
        dag_id='dgov_datasets_rosogrz_mp',
        catchup=False,
    ...
    dgov_datasets_rosogrz_mp = Runner(
        task_id='dgov_datasets_rosogrz_mp',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsRosogrzMp',
    ...
    command_args >> dgov_datasets_rosogrz_mp
