...
with DAG(
        dag_id='dgov_datasets_memlekettik_auruhanalar_tizbes1',
        catchup=False,
    ...
    dgov_datasets_memlekettik_auruhanalar_tizbes1 = Runner(
        task_id='dgov_datasets_memlekettik_auruhanalar_tizbes1',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsMemlekettikAuruhanalarTizbes1',
    ...
    command_args >> dgov_datasets_memlekettik_auruhanalar_tizbes1