...
with DAG(
        dag_id='dgov_datasets_perechen_gosudarstvennyh_rodi',
        catchup=False,
    ...
    dgov_datasets_perechen_gosudarstvennyh_rodi = Runner(
        task_id='dgov_datasets_perechen_gosudarstvennyh_rodi',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPerechenGosudarstvennyhRodi',
    ...
    command_args >> dgov_datasets_perechen_gosudarstvennyh_rodi