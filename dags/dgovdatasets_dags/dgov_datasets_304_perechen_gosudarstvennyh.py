...
with DAG(
        dag_id='dgov_datasets_304_perechen_gosudarstvennyh',
        catchup=False,
    ...
    dgov_datasets_304_perechen_gosudarstvennyh = Runner(
        task_id='dgov_datasets_304_perechen_gosudarstvennyh',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasets304PerechenGosudarstvennyh',
    ...
    command_args >> dgov_datasets_304_perechen_gosudarstvennyh