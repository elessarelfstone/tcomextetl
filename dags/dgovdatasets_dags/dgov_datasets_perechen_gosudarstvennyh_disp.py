...
with DAG(
        dag_id='dgov_datasets_perechen_gosudarstvennyh_disp',
        catchup=False,
    ...
    dgov_datasets_perechen_gosudarstvennyh_disp = Runner(
        task_id='dgov_datasets_perechen_gosudarstvennyh_disp',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPerechenGosudarstvennyhDisp',
    ...
    command_args >> dgov_datasets_perechen_gosudarstvennyh_disp