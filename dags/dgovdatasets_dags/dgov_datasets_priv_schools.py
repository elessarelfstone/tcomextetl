...
with DAG(
        dag_id='dgov_datasets_private_schools',
        catchup=False,
    ...
    dgov_datasets_private_schools = Runner(
        task_id='dgov_datasets_private_schools',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPrivateSchools',
    ...
    command_args >> dgov_datasets_private_schools
