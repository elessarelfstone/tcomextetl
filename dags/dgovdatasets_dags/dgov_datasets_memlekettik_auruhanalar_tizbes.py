...
with DAG(
        dag_id='dgov_datasets_memlekettik_auruhanalar_tizbes',
        catchup=False,
    ...
    dgov_datasets_memlekettik_auruhanalar_tizbes = Runner(
        task_id='dgov_datasets_memlekettik_auruhanalar_tizbes',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsMemlekettikAuruhanalarTizbes',
    ...
    command_args >> dgov_datasets_memlekettik_auruhanalar_tizbes