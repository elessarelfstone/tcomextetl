...
with DAG(
        dag_id='dgov_datasets_277_perechen_gosudarstvennyh2',
        catchup=False,
    ...
    dgov_datasets_perechen_gosudarstvennyh2 = Runner(
        task_id='dgov_datasets_277_perechen_gosudarstvennyh2',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsPerechenGosudarstvennyh',
    ...
    command_args >> dgov_datasets_perechen_gosudarstvennyh2
