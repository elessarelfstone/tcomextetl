...
with DAG(
        dag_id='dgov_datasets_memlekettik_balabakshalar_tura',
        catchup=False,
    ...
    dgov_datasets_memlekettik_balabakshalar_tura = Runner(
        task_id='dgov_datasets_memlekettik_balabakshalar_tura',
        luigi_module='dgov_datasets',
        luigi_task='DgovDatasetsMemlekettikBalabakshalarTura',
    ...
    command_args >> dgov_datasets_memlekettik_balabakshalar_tura
