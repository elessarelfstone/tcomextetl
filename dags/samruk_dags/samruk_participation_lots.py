...
with DAG(
        dag_id='samruk_participation_lots',
        catchup=False,
    ...
    samruk_participation_lots = Runner(
        task_id='samruk_participation_lots',
        luigi_module='samruk',
        luigi_task='SamrukParticipationLots',
    ...
    command_args >> samruk_participation_lots
